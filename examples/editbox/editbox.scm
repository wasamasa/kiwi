...
(kw:release-font! driver fontin)
(kw:release-font! driver dejavu)
(kw:release-render-driver! driver)
(kw:release-rect! frame-geometry)
(kw:release-rect! button-geometry)
(kw:release-rect! inner-frame-geometry)
(kw:release-rect! content-editbox-geometry)
(kw:release-rect! content-label-geometry)
(kw:release-rect! confirmation-editbox-geometry)
(kw:release-rect! confirmation-label-geometry)
